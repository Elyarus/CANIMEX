...
document.addEventListener("DOMContentLoaded", function () {
  var formulario = document.getElementById("formularioInicioSesion"); // Agregar eventos de validación a los campos de entrada
  ...
  formulario.addEventListener("submit", function (event) {
    ...
    var password = document.getElementById("password").value; // Validar el correo electrónico y la contraseña
...
//# sourceMappingURL=validacion_inicio_sesion.dev.js.map
